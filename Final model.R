...
degree_of_freedom<- max(data)

hist<- hist(d$Infections,dw$Infections, dwo$Infections)
par(mfrow=c(3,1))
hist(d$Infections,col = "red",breaks = 40,xlab = "Simulated Reproductive Numbers", ylab = "Frequencies",xlim = c(0,40),ylim = c(0,25000),main = "Histogram of Simulated Reproductive Numbers Without Interventions In 50,000 Simulations" )
hist(dw$Infections,col = "green", breaks = 40,xlab = "Simulated Reproductive Numbers", ylab = "Frequencies", xlim = c(0,40),ylim = c(0,25000),main = "Histogram of Simulated Reproductive Numbers With Two Test Sessions Per Week In 50,000 Simulations" )
hist(dwo$Infections,breaks = 40,col = "blue",xlab = "Simulated Reproductive Numbers", ylab = "Frequencies",xlim = c(0,40),ylim = c(0,25000),main = "Histogram of Simulated Reproductive Numbers With Two Tests Per Testing Session In 50,000 Simulations")

hist

groupColors <- c("None"="#F8766D", "With.Two.Test.Sessions.Per.Week"="#00BA38", "With.Two.Tests.Per.Test.Session"="#619CFF")
...
library(tidyverse)
library(ggplot2)
dens <- ggplot() +xlab("Reproductive Numbers")+ylab("Density")+ggtitle("Kernel Density Plot of Simulated Reproductive Numbers In 50,000 Simulations")+
  geom_density(data = melted,color = "Black",aes(x= value,color= variable,fill = fct_rev(variable),alpha=0.00000001))+guides(alpha=FALSE)+labs(fill="Interventions")+xlim(0,45)+ scale_fill_manual(values=groupColors)

dens

box <- ggplot()+geom_boxplot(data=melted,aes(x=variable, fill= variable, y=value, alpha = 0.001 ))+
  theme(legend.position="none")+xlab("Interventions")+ylab("Simulated Reproductive Numbers")+
  ggtitle("Statistical Summary of Simulated Reproductive Numbers by Interventions In 50,000 Trials")+
  stat_summary(fun.y=mean, geom="point", shape=23, size=5,color="black")
...
degree_of_freedom
summary(d$Infections)
summary(dw$Infections)
summary(dwo$Infections)